...
public class LooisApiTest {
    ...
    public void setup(){
        asyncToSync();
        loois = new LooisApiImpl(new HttpService(LOOIS_TEST_URL));
    }
    ...
    @Test
    public void testLooisTickerFlowable() {
        loois.looisTickerFlowable()
                .subscribe(new LooisSubscriber<List<Market>>() {
                    @Override
                    public void onSuccess(List<Market> list) {
                        log("testLooisTickerFlowable", list.size());
                    }

                    @Override
                    public void onFailed(Throwable throwable) {
                        log("testLooisTickerFlowable", throwable.getLocalizedMessage());
                    }
                });
    }
